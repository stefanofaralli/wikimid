...
public class BabelNetContextEN extends Context<BabelSynset> {
    ...
    public IntegerCounter<String> getContext(BabelSynset elem) {
        ...
        try {
            for (BabelGloss s : elem.getGlosses(Language.EN)) {
            ...
            Logger.getLogger(BabelNetContextEN.class.getName()).log(Level.SEVERE, null, ex);
        }
